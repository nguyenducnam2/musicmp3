...
public class DownloadAllowedApiController {
    ...
    public List<DownloadAllowed> findByAccountId(@RequestParam("accountId")Long accountId){
        List<DownloadAllowed> list=new ArrayList();
        for(DownloadAllowed item:service.findAll()){
