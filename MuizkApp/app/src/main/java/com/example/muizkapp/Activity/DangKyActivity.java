...
import com.example.muizkapp.Fragment.Dialog_Dangky_Free;
...
public class DangKyActivity extends AppCompatActivity implements Dialog_Dangky_Free.ExampleDialogListener   {
    ...
    private void register(HashMap<String, String> params) {
        ...
        Call<FeedbackRegister> registerCall = networkService.register(params);
        registerCall.enqueue(new Callback<FeedbackRegister>() {
            @Override
            public void onResponse(@NonNull Call<FeedbackRegister> call, @NonNull Response<FeedbackRegister> response) {
                FeedbackRegister responseBody = response.body();
            ...
            @Override
            public void onFailure(@NonNull Call<FeedbackRegister> call, @NonNull Throwable t) {
                progressDialog.dismiss();
            }
        });
    }
